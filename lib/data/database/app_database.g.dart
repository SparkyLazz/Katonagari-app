...
class $WalletsTable extends Wallets with TableInfo<$WalletsTable, Wallet> {
  ...
  List<GeneratedColumn> get $columns =>
      [id, name, balance, currency, icon, createdAt];
  @override
...
class Wallet extends DataClass implements Insertable<Wallet> {
  ...
  @override
  int get hashCode => Object.hash(id, name, balance, currency, icon, createdAt);
  @override
...
class $CategoriesTable extends Categories
  ...
  late final GeneratedColumn<String> color = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant('#C4A778'));
...
class $TransactionsTable extends Transactions
  ...
  static const VerificationMeta _isOneTimeMeta =
      const VerificationMeta('isOneTime');
  @override
  late final GeneratedColumn<bool> isOneTime = GeneratedColumn<bool>(
      'is_one_time', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("is_one_time" IN (0, 1))'),
      defaultValue: const Constant(false));
  ...
  VerificationContext validateIntegrity(Insertable<Transaction> instance,
    ...
    if (data.containsKey('is_one_time')) {
      context.handle(
          _isOneTimeMeta,
          isOneTime.isAcceptableOrUnknown(
              data['is_one_time']!, _isOneTimeMeta));
    }
  ...
  Transaction map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Transaction(
      ...
      isOneTime: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}is_one_time'])!,
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  @override
  int get hashCode => Object.hash(id, walletId, categoryId, type, amount, note,
      date, isOneTime, isRecurring, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, Budget> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, categoryId, amount, month, year, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $GoalsTable extends Goals with TableInfo<$GoalsTable, Goal> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, icon, targetAmount, savedAmount, targetDate, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $DebtsTable extends Debts with TableInfo<$DebtsTable, Debt> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, type, personName, amount, dueDate, note, isPaid, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [wallets, categories, transactions, budgets, goals, debts];
}
...
class $$TransactionsTableFilterComposer
  ...
  ColumnFilters<bool> get isOneTime => $composableBuilder(
      column: $table.isOneTime, builder: (column) => ColumnFilters(column));
...
class $$TransactionsTableOrderingComposer
  ...
  ColumnOrderings<bool> get isOneTime => $composableBuilder(
      column: $table.isOneTime, builder: (column) => ColumnOrderings(column));
